...
people = [
    ...
    Person(github_login='Belen96x', first_name='Belen', last_name='Saavedra', facts=['I am a linguist', 'I travel with my cat', 'I can fly']),
    Person(github_login='tunji17', first_name='Oyetunji', last_name='Abioye', facts=['I am not Nigerian', 'I am a Ms student', 'I can fly']),
    Person(github_login="robin", first_name="Tweety", last_name="Bird", facts=["I have arms", "I can fly", "I eat worms"]),
